...
//        let cameraItems = InputBarButtonItem(type: .system)
//        cameraItems.tintColor = #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1)
//        let cameraImage = UIImage(systemName: "camera")
//        cameraItems.image = cameraImage
//        cameraItems.addTarget(self,
//                              action: #selector(cameraButtonPressed), for: .primaryActionTriggered)
//        cameraItems.setSize(CGSize(width: 60, height: 30), animated: false)
//        messageInputBar.leftStackView.alignment = .center
//        messageInputBar.setLeftStackViewWidthConstant(to: 50, animated: false)
//        messageInputBar.setStackViewItems([cameraItems], forStack: .left, animated: false)
//    }
